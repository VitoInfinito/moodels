 ...
 * @generated
 */
public class BookablesManagerTest extends TestCase {
	 ...
	 * @generated
	 */
	protected BookablesManager fixture = null;
	...
	public static void main(String[] args) {
		TestRunner.run(BookablesManagerTest.class);
	}
	 ...
	 * @generated
	 */
	public BookablesManagerTest(String name) {
		super(name);
	}
	 ...
	 * @generated
	 */
	protected void setFixture(BookablesManager fixture) {
	 ...
	 * @generated
	 */
	protected BookablesManager getFixture() {
		return fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(BookablesFactory.eINSTANCE.createBookablesManager());
	}
