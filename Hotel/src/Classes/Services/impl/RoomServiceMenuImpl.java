 ...
 * <ul>
 *   <li>{@link Classes.Services.impl.RoomServiceMenuImpl#getName <em>Name</em>}</li>
 *   <li>{@link Classes.Services.impl.RoomServiceMenuImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomServiceMenuImpl extends MinimalEObjectImpl.Container implements RoomServiceMenu {
	...
	protected EClass eStaticClass() {
		return ServicesPackage.Literals.ROOM_SERVICE_MENU;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicesPackage.ROOM_SERVICE_MENU__NAME:
				return getName();
			case ServicesPackage.ROOM_SERVICE_MENU__ITEMS:
				return getItems();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ServicesPackage.ROOM_SERVICE_MENU___SET_NAME:
				setName();
				return null;
