...
public interface IBookings extends EObject {
	 ...
	 * @generated
	 */
	String makeBooking(List<String> bookables, String customerID, LocalDateTime from, LocalDateTime to, int nbrGuests, String ccNumber, String ccv, int expiryMonth, int expiryYear, String firstName, String lastName, double discountFactor) throws SOAPException, InvalidIDException, IllegalArgumentException, InvalidCreditCardException;
