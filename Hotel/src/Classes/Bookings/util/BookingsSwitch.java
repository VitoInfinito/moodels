 ...
 * @generated
 */
public class BookingsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BookingsPackage.BOOKING: {
				Booking booking = (Booking)theEObject;
				T result = caseBooking(booking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BookingsPackage.BOOKINGS_MANAGER: {
				BookingsManager bookingsManager = (BookingsManager)theEObject;
				T result = caseBookingsManager(bookingsManager);
				if (result == null) result = caseIBookings(bookingsManager);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BookingsPackage.IBOOKINGS: {
	 ...
	 * @generated
	 */
	public T caseBookingsManager(BookingsManager object) {
		return null;
	}
