...
public class GuestsPackageImpl extends EPackageImpl implements GuestsPackage {
	 ...
	 * @generated
	 */
	public EOperation getIGuests__ChangeGuestFirstName() {
	 ...
	 * @generated
	 */
	public EOperation getIGuests__GetGuestLastName() {
	...
	public void createPackageContents() {
		...
		createEOperation(iGuestsEClass, IGUESTS___CHANGE_GUEST_FIRST_NAME);
		...
		createEOperation(iGuestsEClass, IGUESTS___GET_GUEST_LAST_NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getGuestsManager_Guest(), theECoreMapEntriesPackage.getStringToGuestMap(), null, "guest", null, 0, -1, GuestsManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEOperation(getIGuests__ChangeGuestFirstName(), null, "changeGuestFirstName", 1, 1, IS_UNIQUE, !IS_ORDERED);
		...
		initEOperation(getIGuests__GetGuestLastName(), null, "getGuestLastName", 1, 1, IS_UNIQUE, !IS_ORDERED);
