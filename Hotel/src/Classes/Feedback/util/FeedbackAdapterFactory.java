...
public class FeedbackAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeedbackSwitch<Adapter> modelSwitch =
		new FeedbackSwitch<Adapter>() {
			@Override
			public Adapter caseIFeedback(IFeedback object) {
				return createIFeedbackAdapter();
			}
			@Override
			public Adapter caseFeedbackManager(FeedbackManager object) {
				return createFeedbackManagerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link Classes.Feedback.IFeedback <em>IFeedback</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIFeedbackAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Classes.Feedback.FeedbackManager <em>Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeedbackManagerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link Classes.Feedback.Feedback <em>Feedback</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
