...
public interface IStaff extends Serializable {
	 ...
	 * 		keyword != null
	 * Ensures:
	 * 	 	returns a non-null list of all staff ids matching something in the following order:
	 * 			1. Staff with id that exactly matches the keyword
	 * 			2. Staff with id that has some matching to the keyword
	 * <!-- end-user-doc -->
	 ...
	 * 		from != null && to != null
	 * Ensures:
	 * 		that staff will be scheduled on that specified time period 
	 * 		based on statistics.
	 * <!-- end-user-doc -->
