 ...
 *   <li>{@link Classes.Staff.impl.HourlySalaryContractImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HourlySalaryContractImpl extends SalaryContractImpl implements HourlySalaryContract {
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaffPackage.HOURLY_SALARY_CONTRACT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaffPackage.HOURLY_SALARY_CONTRACT__SALARY:
				return getSalary();
			case StaffPackage.HOURLY_SALARY_CONTRACT__TYPE:
				return getType();
		}
