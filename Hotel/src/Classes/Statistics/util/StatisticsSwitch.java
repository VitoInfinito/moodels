...
public class StatisticsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StatisticsPackage.STATISTIC: {
				Statistic statistic = (Statistic)theEObject;
				T result = caseStatistic(statistic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatisticsPackage.STATISTIC_ENTRY: {
				StatisticEntry statisticEntry = (StatisticEntry)theEObject;
				T result = caseStatisticEntry(statisticEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatisticsPackage.DATE: {
				Date date = (Date)theEObject;
				T result = caseDate(date);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatisticsPackage.ISTATISTICS_GENERATOR: {
				IStatisticsGenerator iStatisticsGenerator = (IStatisticsGenerator)theEObject;
				T result = caseIStatisticsGenerator(iStatisticsGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatisticsPackage.STATISTICS_GENERATOR: {
				StatisticsGenerator statisticsGenerator = (StatisticsGenerator)theEObject;
				T result = caseStatisticsGenerator(statisticsGenerator);
				if (result == null) result = caseIStatisticsGenerator(statisticsGenerator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>IStatistics Generator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>IStatistics Generator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIStatisticsGenerator(IStatisticsGenerator object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseStatisticsGenerator(StatisticsGenerator object) {
		return null;
	}
